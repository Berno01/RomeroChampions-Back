...
public interface InventarioRepository extends JpaRepository<InventarioEntity, Integer> {
     ...
     */
    @Query("SELECT new com.sistemasTarija.romeroChampions.inventario.application.dto.InventarioResumenDTO(" +
            "m.id, " +                                    // idModelo
            ...
            "WHERE m.estado = true " +
            "GROUP BY m.id, m.nombre, cat.nombre, ma.nombre, es.nombre " +
            "ORDER BY m.nombre")
