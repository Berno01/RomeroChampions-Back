...
public interface ModeloCatalogoRepository extends JpaRepository<ModeloCatalogoEntity, Integer> {
     ...
     */
    @Query("SELECT new com.sistemasTarija.romeroChampions.recepcion.application.dto.catalogo.ResumenModeloDTO(" +
     ...
     */
    @Query("SELECT new com.sistemasTarija.romeroChampions.recepcion.infrastructure.adapter.out.persistenace.dto.ModeloRawDTO(" +
            "m.id, " +                  // idModelo
