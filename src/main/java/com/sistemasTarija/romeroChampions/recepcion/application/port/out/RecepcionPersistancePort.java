package com.sistemasTarija.romeroChampions.recepcion.application.port.out;
...
public interface RecepcionPersistancePort {
    ...
    List<com.sistemasTarija.romeroChampions.recepcion.domain.model.RecepcionResumen> findAllResumenByFilters(Integer idSucursal, LocalDateTime fechaInicio, LocalDateTime fechaFin);
}
